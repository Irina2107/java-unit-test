...
public void checkIsAdultWhenAgeIsLessThan18False(){
    ...
    assertEquals("Должно вернуться false, так как пользователю 18 лет", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True(){
    ...
    assertEquals("Должно вернуться true, так как пользователь младше 18 лет", true, isAdult);
}
